    ...
    <div class="table w-full">
        <div class="table-header-group border">
            <div class="table-row table-caption font-bold">
                ...
                <div class="table-cell bg-gray-400 text-gray-700 px-4 xs:px-10 py-2 text-sm">Date</div>
                <div class="table-cell bg-gray-400 text-gray-700 px-4 py-2 xs:px-10 text-sm">No. of Events</div>
                <div class="table-cell bg-gray-400 text-gray-700 px-4 py-2 xs:px-10 text-sm">No. of <br/> Participants</div>
                <div class="table-cell bg-gray-400 text-gray-700 px-4 py-2 xs:px-10 text-sm">Invited <br/>Speakers</div>
                <div class="table-cell bg-gray-400 text-gray-700 px-4 py-2 xs:px-10 text-sm">Actions</div>
            </div>
        </div>
        <div class="table-row-group">
            <div class="table-row" v-for="(item,index) in myprogrammes" :key="index">
                ...
                <div class="table-cell bg-gray-400 text-gray-700 px-4 py-2 text-sm"><span v-on:click="loadEvents(item.events)" class="bg-green-700 shadow-2xl hover:shadow-lg w-full rounded px-3 py-1 text-white">{{item.events.length}} <i class="fa fa-eye"></i> </span> </div>
