...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            ...
            <div class="relative h-64 bg-yellow-100 p-4">
                <div class="h-48 inset-x-0 bottom-0 absolute bg-fixed" style="top: 70px; background-image: url('{{asset('images/forum.jpg')}}'); background-size: cover;">
                ...
                <div class="h-12 inset-x-0 bottom-0 absolute" style="top: 230px;">
                    <div class="px-6 py-3 bg-yellow-100 text-black border-yellow-600 border-solid border-b">
                        <h2 class="text-2xl">
                            Forums
                        </h2>
                    </div>
